    ...
    switch (cleanCmd) {
      ...
      case "cat about_me.md":
        output = [
          ...
          { text: "I'm a Computer Science student at Vardhaman College of Engineering (VCE) specialized in machine learning and scalable web backend pipelines.", isSystem: true },
